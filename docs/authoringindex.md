...
1.  Enter a few keywords to find the perfect icon using our [icon search] and
  ...
  [navigation tabs]: MkDocs-Material/setting-up-navigation.md#navigation-tabs
...
??? question "How to set a page template for an entire folder?"
  ...
  [theme extension]: MkDocs-Material/customization.md#extending-the-theme
  [built-in meta plugin]: MkDocs-Material/meta.md
...
```
  ...
  [overriding blocks]: MkDocs-Material/customization.md#overriding-blocks
