...
Back to: [Image Caption](image.md#config-chapter)
...
!!! quote ""
    ...
    - The configuration can be split in three parts: `table`, `figure` and `custom`.
    
    - Each part has the same configuration options that apply for the respective element.
...
!!! info "Overwriting the "default config""
