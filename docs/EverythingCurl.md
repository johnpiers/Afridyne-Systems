...
icon: simple/curl
---
![](imgs/20260103-022407.png){ .center-image }
...
!!! pied-piper "Site"
    ...
    - Is [the home of ***this book***](https://everything.curl.dev). It features the book online in a web version.
    ...
    - ***This book's*** website is hosted by [Fastly](https://www.fastly.com/). The book contents is rendered by [mdBook](https://github.com/rust-lang/mdBook) since March 18th, 2024.
    
## Content

!!! quote ""

    All book content is hosted on GitHub in the [everything-curl](https://github.com/curl/everything-curl) repository.
...
!!! quote ""
    ...
    Preferably, you could submit [errors](https://github.com/curl/everything-curl/issues) or [pullrequests](https://github.com/curl/everything-curl/pulls) on the book's GitHub page.
