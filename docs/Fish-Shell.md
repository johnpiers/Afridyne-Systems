...
<!-- Debian Box -->
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://cdn.simpleicons.org/debian/8 8 8 8 8 8" width="70"><br><br>
  <a href="https://www.debian.org/">Subscribe</a> or <a href="https://download.opensuse.org/repositories/shells:/fish/">Download</a>
</div>
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://fishshell.com/assets/img/fed_icon.png" width="130"><br><br>
...
<!-- Row 2 -->
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://fishshell.com/assets/img/opensuse.svg" width="110"><br><br>
...
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;" align="center">
  ...
  <img src="https://fishshell.com/assets/img/centos-logo-light-vertical.svg#gh-light-mode-only" width="100" alt="CentOS">

  <!-- CentOS Logo for Dark Mode (White Text) -->
  <img src="https://fishshell.com/assets/img/centos-logo-dark-vertical.svg#gh-dark-mode-only" width="100" alt="CentOS">
...
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://fishshell.com/assets/img/arch.svg" width="120"><br><br>
...
<!-- Row 3 -->
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/4/41/Gentoo-logo-dark.svg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original" width="60"><br><br>
  <a href="https://gentoo.org">Packages</a><br>
  <code>emerge fish</code>
</div>
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://fishshell.com/assets/img/void_icon.png" width="60"><br><br>
...
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;" align="center">
  ...
  <img src="https://fishshell.com/assets/img/nixos_icon.svg#gh-light-mode-only" width="60" alt="NixOS">

  <!-- NixOS Logo for Dark Mode -->
  <img src="https://brand.nixos.org/logos/nixos-logo-default-gradient-white-regular-horizontal-recommended.svg#gh-dark-mode-only" width="115" alt="NixOS">
...
<div style="display: inline-block; border: 1px solid #444; border-radius: 6px; padding: 15px; margin: 5px; width: 28%; min-width: 200px; vertical-align: top; min-height: 200px;">
  <img src="https://fishshell.com/assets/img/solus_icon.svg" width="70"><br><br>
