...
- [Overview](https://daringfireball.net/projects/markdown/syntax#overview)
  - [Philosophy](https://daringfireball.net/projects/markdown/syntax#philosophy)
  - [Inline HTML](https://daringfireball.net/projects/markdown/syntax#html)
  - [Automatic Escaping for Special Characters](https://daringfireball.net/projects/markdown/syntax#autoescape)
- [Block Elements](https://daringfireball.net/projects/markdown/syntax#block)
  - [Paragraphs and Line Breaks](https://daringfireball.net/projects/markdown/syntax#p)
...
- [Miscellaneous](https://daringfireball.net/projects/markdown/syntax#misc)
  - [Backslash Escapes](https://daringfireball.net/projects/markdown/syntax#backslash)
