...
![](imgs/20260217-103002.png){ .center-image }
...
![Screenshot](SimpleWeather-development/docs/screenshot.png){ .center-image }

Support for themes, the following screenshot uses the *Immersive* theme:

![Immersive Theme Screenshot](SimpleWeather-development/docs/immersivescreenshot.png){ .center-image }

## Installation

!!! desc "Installation"

    [![Get on GNOME Extensions](SimpleWeather-development/docs/ego.png)](https://extensions.gnome.org/extension/8261/simpleweather/)
