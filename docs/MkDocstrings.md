...
-   <span style="color: #607d8b">:material-language-python:</span> **Language-agnostic**
    [:octicons-arrow-right-24: View Handlers](https://mkdocstrings.github.io){ .md-button style="border-color: #607d8b; color: #607d8b" }
...
-   <span style="color: #89b4fa">:material-palette:</span> **Multiple Themes**
    [:octicons-arrow-right-24: View Theming](https://mkdocstrings.github.io){ .md-button style="border-color: #89b4fa; color: #89b4fa" }

    Supports Material, ReadTheDocs, and MkDocs themes. Each handler can offer unique styling options.

-   <span style="color: #009688">:material-link-variant:</span> **Internal Refs**
    [:octicons-arrow-right-24: View Usage](https://mkdocstrings.github.io/usage/){ .md-button style="border-color: #009688; color: #009688" }
...
-   <span style="color: #607d8b">:material-web:</span> **External Refs**
    [:octicons-arrow-right-24: View Usage](https://www.sphinx-doc.org/en/master/usage/extensions/intersphinx.html){ .md-button style="border-color: #607d8b; color: #607d8b" }

    Reference API items from other libraries using inventory files, similar to Sphinx's intersphinx.

-   <span style="color: #89b4fa">:material-code-json:</span> **Inline Injection**
    [:octicons-arrow-right-24: View Usage](https://github.com/mkdocstrings/mkdocstrings/blob/main/README.md){ .md-button style="border-color: #89b4fa; color: #89b4fa" }

    Inject documentation anywhere using `::: identifier` syntax followed by an indented YAML block.

-   <span style="color: #009688">:material-tune:</span> **Configuration**
    [:octicons-arrow-right-24: View Options](https://mkdocstrings.github.io#global-options){ .md-button style="border-color: #009688; color: #009688" }
