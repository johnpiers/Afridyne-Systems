...
- Enhanced reading time calculation for blog posts, see [post_readtime](MkDocs-Material/blog.md#new-features)
    ...
    - Exposed API for reading time calculation, facilitating invocation and integration by other plugins and hooks, see [analyze_markdown](MkDocs-Material/date-author.md#analyze_markdown)
...
- Added automatic collapse for long code blocks, see: [code-collapse-expand](MkDocs-Material/code-blocks.md#code-collapse-expand){target="_blank"}
...
- Added Markdown page support for AI agents, see [Markdown for AI agents](MkDocs-Material/adding-a-git-repository.md#markdown-for-ai-agents){target="_blank"}
- Added download functionality for fenced code blocks, see [Code download button](MkDocs-Material/code-blocks.md#code-download-button){target="_blank"}
- Added Lucide icons, see [Search](MkDocs-Material/icons-emojis.md#search){target="_blank"}
...
- Significantly updated project documentation, including [plugins](MkDocs-Material/plugin-recommendation.md#graphics-charts), [setup](MkDocs-Material/adding-document-dates-authors.md), [admonitions](admonitions.md#custom-icons-and-colors-example-2-create-new-admonitions) and more

### 10.1.3 <small>April 10, 2026</small> { id="10.1.3" }

- Feature: Bundled icons can now be used as favicon, see [Favicon](MkDocs-Material/changing-the-logo-and-icons.md#favicon-icon-bundled){target="_blank"}
- Feature: Modularized Admonition for easier extensibility
    - Customizing a new admonition can now be done simply by configuring it in `mkdocs.yml`, see [Customization](admonitions.md#custom-icons-and-colors-example-2-create-new-admonitions){target="_blank"}
...
- Date & time infrastructure (provided by the built-in plugin [Date and Authors](MkDocs-Material/adding-document-dates-authors.md))
    ...
    - These date values can be accessed via template variables in any template or plugin, see [Template Variables](MkDocs-Material/date-author.md#template-variables){target="_blank"}
- Recently updated list
    - Added high-performance readtime & summary parsers
    - Added `readtime` and `tag` rendering, for readtime calculation details see [Reading-Time-Estimation](MkDocs-Material/date-author.md#reading-time-estimation){target="_blank"}
    - Added line count configuration for `summary`, see [Summary-Line-Configuration](MkDocs-Material/date-author.md#summary-line-configuration){target="_blank"}
...
- Added configurable styles for topbar, allow to set topbar background color in Liquid Glass theme, see [Topbar style](MkDocs-Material/changing-the-colors.md#topbar-style){target="_blank"}
...
- New: Add a new generation date author plugin, see doc [Add document dates authors](MkDocs-Material/adding-document-dates-authors.md){target="_blank"}
- New: Add recent updates module, see doc [Add recent updates module](adding-recent-updates-module.md){target="_blank"}
...
- Fixed errors in Latvian translations
  ...
  [validation]: MkDocs-Material/creating-your-site.md#minimal-configuration
...
- Initial release
MkDocs-Material/code-blocks.md#code-collapse-expand