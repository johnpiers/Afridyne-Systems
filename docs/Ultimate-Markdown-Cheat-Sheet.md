...
![Markdown cheat-sheet](imgs/20260102-152317.png#only-light){ .center-image }

![Markdown cheat-sheet](imgs/20260102-152141a.png#only-dark){ .center-image }
...
-   <span style="color: #689f38">:material-format-italic:</span> **Italic**
    [:octicons-arrow-right-24: View Italic](#italic){ .md-button style="border-color: #689f38; color: #689f38" }

    Use single underscores or asterisks for subtle emphasis.

-   <span style="color: #EF559F">:material-format-text-variant:</span> **Bold and Italic**
    [:octicons-arrow-right-24: View Combined](#bold-and-italic){ .md-button style="border-color: #EF559F; color: #EF559F" }
...
-   <span style="color: #388e3c">:material-xml:</span> **Syntax Highlighting**
    ...
    Applying colour and formatting to various prog languages.
...
-   <span style="color: #689f38">:material-table:</span> **Diff Code block**
    [:octicons-arrow-right-24: View Diff](#diff-code-block){ .md-button style="border-color: #689f38; color: #689f38" }

    Visualising changes, additions, and deletions in code.

-   <span style="color: #ef6c00">:material-format-align-center:</span> **Alignments**
    [:octicons-arrow-right-24: View Alignments](#alignments){ .md-button style="border-color: #ef6c00; color: #ef6c00" }
...
-   <span style="color: #388e3c">:material-image-multiple:</span> **Picture tag**
    [:octicons-arrow-right-24: View Picture](#using-picture-tag){ .md-button style="border-color: #388e3c; color: #388e3c" }

    Using HTML5 picture tags for advanced image handling.

-   <span style="color: #afb42b">:material-theme-light-dark:</span> **Dark/Light mode**
    [:octicons-arrow-right-24: View Mode](#using-dark-and-light-mode){ .md-button style="border-color: #afb42b; color: #afb42b" }
...
-   <span style="color: #afb42b">:material-alert-circle-outline:</span> **Alerts**
    [:octicons-arrow-right-24: View Alerts](#alerts-8-january-2024){ .md-button style="border-color: #afb42b; color: #afb42b" }

    Warning, info, and success callouts (admonitions).

-   <span style="color: #388e3c">:material-account-group:</span> **Mentions**
    [:octicons-arrow-right-24: View Mentions](#mention-people-and-teams){ .md-button style="border-color: #388e3c; color: #388e3c" }
...
-   <span style="color: #afb42b">:material-react:</span> **MDX**
    [:octicons-arrow-right-24: View MDX](#mdx){ .md-button style="border-color: #afb42b; color: #afb42b" }

    Using JSX components directly inside your Markdown files.

-   <span style="color: #EF559F">:material-tools:</span> **Tools**
    [:octicons-arrow-right-24: View Tools](#tools){ .md-button style="border-color: #EF559F; color: #EF559F" }
...
| :--- | :--- | :--- |
| **Apricot** | `<font color="#FBB982">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#FBB982">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #FBB982"><font color="#FBB982">The quick brown fox jumps over the lazy dog.</font></span> |
| **Aquamarine** | `<font color="#00B5BE">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00B5BE">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00B5BE"><font color="#00B5BE">The quick brown fox jumps over the lazy dog.</font></span> |
| **Bittersweet** | `<font color="#C04F17">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#C04F17">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #C04F17"><font color="#C04F17">The quick brown fox jumps over the lazy dog.</font></span> |
| **Black** | `<font color="#221E1F">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#221E1F">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #221E1F" style="background-color: #BBB; padding: 2px; border-radius: 3px;"><font color="#221E1F">The quick brown fox jumps over the lazy dog.</font></span> |
| **Blue** | `<font color="#2D2F92">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#2D2F92">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #2D2F92" style="background-color: #CCC; padding: 2px; border-radius: 3px;"><font color="#2D2F92">The quick brown fox jumps over the lazy dog.</font></span> |
| **BlueGreen** | `<font color="#00B3B8">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00B3B8">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00B3B8"><font color="#00B3B8">The quick brown fox jumps over the lazy dog.</font></span> |
| **BlueViolet** | `<font color="#473992">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#473992">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #473992"><font color="#473992">The quick brown fox jumps over the lazy dog.</font></span> |
| **BrickRed** | `<font color="#B6321C">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#B6321C">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #B6321C"><font color="#B6321C">The quick brown fox jumps over the lazy dog.</font></span> |
| **Brown** | `<font color="#792500">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#792500">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #792500"><font color="#792500">The quick brown fox jumps over the lazy dog.</font></span> |
| **BurntOrange** | `<font color="#F7921D">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F7921D">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F7921D"><font color="#F7921D">The quick brown fox jumps over the lazy dog.</font></span> |
| **CadetBlue** | `<font color="#74729A">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#74729A">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #74729A"><font color="#74729A">The quick brown fox jumps over the lazy dog.</font></span> |
| **CarnationPink** | `<font color="#F282B4">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F282B4">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F282B4"><font color="#F282B4">The quick brown fox jumps over the lazy dog.</font></span> |
| **Cerulean** | `<font color="#00A2E3">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00A2E3">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00A2E3"><font color="#00A2E3">The quick brown fox jumps over the lazy dog.</font></span> |
| **CornflowerBlue** | `<font color="#41B0E4">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#41B0E4">...</font>' title="Copy line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #41B0E4"><font color="#41B0E4">The quick brown fox jumps over the lazy dog.</font></span> |
| **Cyan** | `<font color="#00AEEF">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00AEEF">...</font>' title="Copy line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00AEEF"><font color="#00AEEF">The quick brown fox jumps over the lazy dog.</font></span> |
| **Dandelion** | `<font color="#FDBC42">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#FDBC42">...</font>' title="Copy line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #FDBC42"><font color="#FDBC42">The quick brown fox jumps over the lazy dog.</font></span> |
| **DarkOrchid** | `<font color="#A4538A">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#A4538A">...</font>' title="Copy line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #A4538A"><font color="#A4538A">The quick brown fox jumps over the lazy dog.</font></span> |
| **Emerald** | `<font color="#00A99D">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00A99D">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00A99D"><font color="#00A99D">The quick brown fox jumps over the lazy dog.</font></span> |
| **ForestGreen** | `<font color="#009B55">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#009B55">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #009B55"><font color="#009B55">The quick brown fox jumps over the lazy dog.</font></span> |
| **Fuchsia** | `<font color="#8C368C">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#8C368C">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #8C368C"><font color="#8C368C">The quick brown fox jumps over the lazy dog.</font></span> |
| **Goldenrod** | `<font color="#FFDF42">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#FFDF42">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #FFDF42"><font color="#FFDF42">The quick brown fox jumps over the lazy dog.</font></span> |
| **Gray** | `<font color="#949698">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#949698">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #949698"><font color="#949698">The quick brown fox jumps over the lazy dog.</font></span> |
| **Green** | `<font color="#00A64F">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00A64F">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00A64F"><font color="#00A64F">The quick brown fox jumps over the lazy dog.</font></span> |
| **GreenYellow** | `<font color="#DFE674">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#DFE674">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #DFE674"><font color="#DFE674">The quick brown fox jumps over the lazy dog.</font></span> |
| **JungleGreen** | `<font color="#00A99A">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00A99A">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00A99A"><font color="#00A99A">The quick brown fox jumps over the lazy dog.</font></span> |
| **Lavender** | `<font color="#F49EC4">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F49EC4">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F49EC4"><font color="#F49EC4">The quick brown fox jumps over the lazy dog.</font></span> |
| **LimeGreen** | `<font color="#8DC73E">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#8DC73E">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #8DC73E"><font color="#8DC73E">The quick brown fox jumps over the lazy dog.</font></span> |
| **Magenta** | `<font color="#EC008C">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#EC008C">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #EC008C"><font color="#EC008C">The quick brown fox jumps over the lazy dog.</font></span> |
| **Mahogany** | `<font color="#A9341F">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#A9341F">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #A9341F"><font color="#A9341F">The quick brown fox jumps over the lazy dog.</font></span> |
| **Maroon** | `<font color="#AF3235">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#AF3235">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #AF3235"><font color="#AF3235">The quick brown fox jumps over the lazy dog.</font></span> |
| **Melon** | `<font color="#F89E7B">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F89E7B">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F89E7B"><font color="#F89E7B">The quick brown fox jumps over the lazy dog.</font></span> |
| **MidnightBlue** | `<font color="#006795">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#006795">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #006795" style="background-color: #AAA; padding: 2px; border-radius: 3px;"><font color="#006795">The quick brown fox jumps over the lazy dog.</font></span> |
| **Mulberry** | `<font color="#A93C93">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#A93C93">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #A93C93"><font color="#A93C93">The quick brown fox jumps over the lazy dog.</font></span> |
| **NavyBlue** | `<font color="#006EB8">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#006EB8">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #006EB8" style="background-color: #AAA; padding: 2px; border-radius: 3px;"><font color="#006EB8">The quick brown fox jumps over the lazy dog.</font></span> |
| **OliveGreen** | `<font color="#3C8031">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#3C8031">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #3C8031"><font color="#3C8031">The quick brown fox jumps over the lazy dog.</font></span> |
| **Orange** | `<font color="#F58137">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F58137">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F58137"><font color="#F58137">The quick brown fox jumps over the lazy dog.</font></span> |
| **OrangeRed** | `<font color="#ED135A">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#ED135A">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #ED135A"><font color="#ED135A">The quick brown fox jumps over the lazy dog.</font></span> |
| **Orchid** | `<font color="#AF72B0">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#AF72B0">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #AF72B0"><font color="#AF72B0">The quick brown fox jumps over the lazy dog.</font></span> |
| **Peach** | `<font color="#F7965A">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F7965A">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F7965A"><font color="#F7965A">The quick brown fox jumps over the lazy dog.</font></span> |
| **Periwinkle** | `<font color="#7977B8">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#7977B8">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #7977B8"><font color="#7977B8">The quick brown fox jumps over the lazy dog.</font></span> |
| **PineGreen** | `<font color="#008B72">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#008B72">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #008B72"><font color="#008B72">The quick brown fox jumps over the lazy dog.</font></span> |
| **Plum** | `<font color="#92268F">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#92268F">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #92268F"><font color="#92268F">The quick brown fox jumps over the lazy dog.</font></span> |
| **ProcessBlue** | `<font color="#00B0F0">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#00B0F0">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #00B0F0"><font color="#00B0F0">The quick brown fox jumps over the lazy dog.</font></span> |
| **Purple** | `<font color="#99479B">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#99479B">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #99479B"><font color="#99479B">The quick brown fox jumps over the lazy dog.</font></span> |
| **RawSienna** | `<font color="#974006">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#974006">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #974006"><font color="#974006">The quick brown fox jumps over the lazy dog.</font></span> |
| **Red** | `<font color="#ED1B23">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#ED1B23">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #ED1B23"><font color="#ED1B23">The quick brown fox jumps over the lazy dog.</font></span> |
| **RedOrange** | `<font color="#F26035">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F26035">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F26035"><font color="#F26035">The quick brown fox jumps over the lazy dog.</font></span> |
| **RedViolet** | `<font color="#A1246B">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#A1246B">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #A1246B"><font color="#A1246B">The quick brown fox jumps over the lazy dog.</font></span> |
| **Rhodamine** | `<font color="#EF559F">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#EF559F">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #EF559F"><font color="#EF559F">The quick brown fox jumps over the lazy dog.</font></span> |
| **RoyalBlue** | `<font color="#0071BC">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#0071BC">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #0071BC"><font color="#0071BC">The quick brown fox jumps over the lazy dog.</font></span> |
| **RoyalPurple** | `<font color="#613F99">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#613F99">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #613F99"><font color="#613F99">The quick brown fox jumps over the lazy dog.</font></span> |
| **RubineRed** | `<font color="#ED017D">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#ED017D">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #ED017D"><font color="#ED017D">The quick brown fox jumps over the lazy dog.</font></span> |
| **Salmon** | `<font color="#F69289">...</font>` <span class="copy-btn" data-clipboard-text='<font color="#F69289">...</font>' title="Copy Code Line" style="cursor:pointer; margin-left:8px;">:material-content-copy:</span> | <span title="Hex: #F69289"><font color="#F69289">The quick brown fox jumps over the lazy dog.</font></span> |

[Go to: Full Table :fontawesome-solid-paper-plane:](MathJax.md/#text-colours){ .md-button .md-button--custom }
...
!!! info "Alignments"
    ...
    ??? info "Click to see code"
        ...
        ```markdown
        ![Vintage clock](https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80){ width=100 }
        ```
...
!!! info "Footnotes"
    ...
    <img src="https://github.com/lifeparticle/Markdown-Cheatsheet/assets/1612112/f55f13ff-8566-48f8-9353-edf3474523fd" width="250">
...
!!! info "Highlight Words and Link it to a URL"
...
!!! info "Use relative header"
    ...
    ![ ](./supported_file_extensions/md.svg  "Animated SVG of the text 'Markdown-Cheatsheet' in white letters.")
...
[![Binary Tree](imgs/20260317-121841.png#gh-light-mode-only)](https://binarytree.dev)
[![Binary Tree](imgs/20260317-122421.png#gh-dark-mode-only)](https://binarytree.dev)
...
!!! example "Using Dark and Light Mode"
...
!!! info "Horizontal Images"
    <div markdown="1" style="display: flex; gap: 4px;">
...
!!! info "Vertical Images"
    <div markdown="1" style="display: flex; flex-direction: column; gap: 0px;">
    <img src="https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80" width="100" height="100" alt="alt text"/>
    <img src="https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80" width="100" height="100" alt="alt text"/>
    <img src="https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80" width="100" height="100" alt="alt text"/>
    </div>
...
!!! info "Vertical images With Gap"
    <div markdown="1" style="display: flex; flex-direction: column; gap: 2px;">
    <img src="https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80" width="100" height="100" alt="alt text"/>
    <img src="https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80" width="100" height="100" alt="alt text"/>
    <img src="https://images.unsplash.com/photo-1415604934674-561df9abf539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2772&q=80" width="100" height="100" alt="alt text"/>
    </div>
...
!!! danger "Videos"
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/8RyJS7rDaM0?si=gfCdOiyGL2sWwrJ5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
!!! tip ""
    ...
    ```md
    <kbd> <br> [MD-Cheatsheet](https://github.com/lifeparticle/Markdown-Cheatsheet)↗️ <br> </kbd>
    ```
