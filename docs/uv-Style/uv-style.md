...
![](imgs/20260215-115705.png){: style="display: block; margin: 0 auto"}

<div style="display: none;">
  <h1>uv Style</h1>
</div>

<H1 style="text-align: center;">uv Style Guide</H1>
...
!!! recommendation "General"
    ...
    1. Use a space, not an equals sign, for command-line arguments with a value, e.g. `--resolution lowest`, not `--resolution=lowest`.
    
## Styling uv

!!! deep-dive "Styling uv"

    ***Just uv, please.***{.bright-large}
...
!!! deep-dive "Colours and Style"
    ...
    4. In general, use:
        ...
        ==1==. <span style="color: #009900;">Green</span> for success.
        ==2==. <span style="color: #FF0000;">Red</span> for error.
        ==3==. <span style="color: #CC9900;">Yellow</span> for warning.
        ==4==. <span style="color: #009999;">Cyan</span> for hints.
        ==5==. <span style="color: #009999;">Cyan</span> for file paths.
        ==6==. <span style="color: #009999;">Cyan</span> for important user-facing literals (e.g., a package name in a message).
        ==7==. <span style="color: #009900;">Green</span> for commands.
