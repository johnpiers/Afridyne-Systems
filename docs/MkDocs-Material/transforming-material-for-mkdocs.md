...
![](imgs/20260517-220739.png){ .center-image }

<H3 style="text-align: center;">How We're Transforming Material for MkDocs.</H3>

!!! deep-dive "Feature Changes and Zenzical"
...
!!! tldr "First Article in a Four-part Series"
  ...
  [What MkDocs 2.0 means for your documentation projects]: https://github.com/squidfunk/mkdocs-material/blob/master/docs/blog/posts/mkdocs-2.0.md

## A Success Story

!!! decision "A Success Story"
...
!!! recommendation "Search and Discovery"
  ...
  [unmaintained since 2020]: https://github.com/olivernn/lunr.js/releases/tag/v2.3.9
...
!!! deep-dive "Translations and Versioning"
...
!!! important "Large Language Models (LLM's)"
...
!!! grey "Team, Transparency, and Growth"
