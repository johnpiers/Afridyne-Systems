...
---
![](imgs/20260121-174447.png){: style="display: block; margin: 0 auto"}
<H1 style="text-align: center;">Image Processing</H1>

!!! quote "Image Processing"

    1. Some of the [built-in plugins] depend on external libraries for efficient image processing, most notably the [social] plugin to generate [social cards], and the [optimize] plugin for applying [image optimization].
    
    2. This guide explains how to install those libraries in different environments.
