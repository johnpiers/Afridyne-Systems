...
<H4 style="text-align: center;">Zensical – A modern static site generator built by the Material for MkDocs team.</H4>
...
![Zensical](../assets/assets/screenshot.png#gh-light-mode-only)
![Zensical](../assets/assets/screenshot-dark.png#gh-dark-mode-only)


  <figcaption markdown>Our public [roadmap], built with Zensical</figcaption>
</figure>

!!! recommendation "Ensuring Maximum Compatibility"
...
![Zensical](../assets/assets/screenshot-search.png#gh-light-mode-only)
![Zensical](../assets/assets/screenshot-search-dark.png#gh-dark-mode-only)

  <figcaption markdown>Disco on [zensical.org]</figcaption>
</figure>

!!! desc "Disco Release 2026"
...
!!! education "Authoring Experience."
...
!!! instruction "Maximum Compatibility"
...
!!! recommendation "Zensical Spark"

    Zensical Spark, [our offering for professionals], is the result of countless calls with professional users of Material for MkDocs. From startups to large enterprises, we enable organizations to realize complex projects in diverse environments. For this, we've created Zensical Spark as a collaborative space.
...
!!! decision "We're Growing our Team"
...
!!! tldr "Where we'll be in 12 months"
...
!!! recommendation "Connect with us"
