...
- [Sub- and superscripts]
  ...
  [Highlighting text]: formatting.md#highlighting-text
  [Sub- and superscripts]: formatting.md#sub-and-superscripts
...
- [Using icons in templates]
  ...
  [Using emojis]: icons-emojis.md#using-emojis
  [Using icons]: icons-emojis.md#using-icons
  [Using icons in templates]: icons-emojis.md#using-icons-in-templates
...
- [Custom syntax theme]
  ...
  [title]: code-blocks.md#adding-a-title
  [Adding line numbers]: code-blocks.md#adding-line-numbers
  [Using code blocks]: code-blocks.md#usage
  [Adding a title]: code-blocks.md#adding-a-title
  [Highlighting specific lines]: code-blocks.md#highlighting-specific-lines
  [Custom syntax theme]: code-blocks.md#custom-syntax-theme
...
- [Using entity-relationship diagrams]
  ...
  [Using content tabs]: content-tabs.md#usage
  [Using flowcharts]: diagrams.md#using-flowcharts
  [Using sequence diagrams]: diagrams.md#using-sequence-diagrams
  [Using state diagrams]: diagrams.md#using-state-diagrams
  [Using class diagrams]: diagrams.md#using-class-diagrams
  [Using entity-relationship diagrams]: diagrams.md#using-entity-relationship-diagrams
...
- [Embedded content]
  ...
  [Grouping code blocks]: content-tabs.md#grouping-code-blocks
...
!!! abstract "Abstract"
       ...
       - [x] <p dir="auto">Other libraries like <a href="https://github.com/Khan
       /KaTeX">KaTeX</a> are also supported and can be integrated with some additional effort.
       - [ ] See the <a href="https://facelessuser.github.io/pymdown-extensions/extensions/arithmatex/#loading-katex">Arithmatex documentation on KaTeX</a> for further guidance, as this is beyond the scope of Material for MkDocs.
