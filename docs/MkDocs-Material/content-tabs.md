...
You can copy the link of the tab and create a link on the same or any other page. For example, you can [jump to the third tab above this paragraph][tab_1].
...
=== "Feature disabled"
  ...
  [Linked content tabs enabled]: ../assets/assets/screenshots/content-tabs-link.png
  [Linked content tabs disabled]: ../assets/assets/screenshots/content-tabs.png
