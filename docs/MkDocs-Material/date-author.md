...
![](imgs/date-author.png){ .center-image }
<H1 style="text-align: center;"><ins>Built-in document-dates plugin</ins></H1>

!!! desc "Document-dates Plugin"
...
![render](../screenshots/document-dates.gif)
...
!!! tip "Infrastructure support"
    ...
    In addition, this plugin completely resolved date and time infrastructure issues, enabling the project to support automated date processing.
    
    **Manual date configuration is no longer required for any feature**, including: page date display, blog post dates, blog date archives, blog list sorting, sitemap.xml (lastmod - SEO improvements), RSS feeds, recently updated section, search ranking, and more.
...
!!! education "Enhanced Author Configuration"
...
!!! desc "Set correct `lastmod` for Sitemap"
...
!!! recommendation "Recustomize Plugin"
...
!!! version-added "Recently Updated Module"
...
!!! abstract "Add to Sidebar Navigation"
...
!!! example "Add Anywhere in Document"
...
!!! recommendation "Configure Article Cover"
...
!!! recommendation "Summary Line Configuration"
...
!!! education "Reading Time Estimation"
...
!!! recommendation "Load_dates_and_authors"
...
!!! example "Sample Call or Reading Time Only"
