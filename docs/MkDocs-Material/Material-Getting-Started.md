...
---
![](imgs/20260216-195724.png){ .center-image }
...
!!! info "Installation"
    ...
    === "9.x"
        ...
        1.  Material for MkDocs uses [semantic versioning] [^2], which is why it's a good idea to limit upgrades to the current major version.
