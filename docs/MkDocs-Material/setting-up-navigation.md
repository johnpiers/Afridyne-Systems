...
<H1 style="text-align: center;"><u>Setting Up Navigation</u></H1>
...
[Attribute Lists](python-markdown.md#attribute-lists){ data-preview }
...
!!! info "Full configuration example"
    ...
    1.  Sources specify the pages _on_ which instant previews should be
    enabled. If this setting is omitted, instant previews will be enabled on all pages. You can use patterns to include or exclude pages.
    Exclusion is evaluated on top of inclusion, so if a page is matched by both, it will be excluded.
    
    2.  Targets specify the pages _to_ which instant previews should be
    enabled. This is the recommended way to enable instant
    previews.
    
    !!! info "Note!"
        That you can define multiple items under the `configurations`setting, which allows to precisely control where instant previews are shown.
        
    
---

!!! instruction "Instant Previews Globally"
...
=== "Without"
  ...
  [Navigation tabs enabled]: ../assets/assets/screenshots/navigation-tabs.png
  [Navigation tabs disabled]:../assets/assets/screenshots/navigation.png

#### Sticky Navigation Tabs

!!! desc "Sticky Navigation Tabs"
...
=== "Without"
  ...
  [Sticky navigation tabs enabled]: ../assets/assets/screenshots/navigation-tabs-sticky.png
  [Sticky navigation tabs disabled]: ../assets/assets/screenshots/navigation-tabs-collapsed.png

### Navigation Sections

!!! desc "Navigation Sections"
...
=== "Without"
  ...
  [Navigation sections enabled]: ../assets/assets/screenshots/navigation-sections.png
  [Navigation sections disabled]: ../assets/assets/screenshots/navigation.png

!!! important
    Both feature flags, [`navigation.tabs`][tabs] and[`navigation.sections`][sections], can be combined with each other. If both feature flags are enabled, sections are rendered for level 2 navigation items.
    
### Navigation Expansion

!!! desc "Navigation Expansion"
...
=== "Without"
  ...
  [Navigation expansion enabled]: ../assets/assets/screenshots/navigation-expand.png
  [Navigation expansion disabled]: ../assets/assets/screenshots/navigation.png

### Navigation Path <small>Breadcrumbs</small> { id=navigation-path }

!!! desc "`Navigation Path Breadcrumbs`"
...
=== "Without"
  ...
  [Navigation path enabled]: ../assets/assets/screenshots/navigation-path-on.png
  [Navigation path disabled]: ../assets/assets/screenshots/navigation-path-off.png

### Navigation Pruning

!!! desc "Navigation Pruning"
    ...
    1.  This feature flag is not compatible with [`navigation.expand`] [navigation.expand], as
    navigation expansion requires the complete navigation structure.
...
!!! desc "Section Index Pages"
    ...
    1.  This feature flag is not compatible with [`toc.integrate`][toc.integrate], as
...
!!! desc ""
  ...
  [Section index pages enabled]: ../assets/assets/screenshots/navigation-index-on.png
  [Section index pages disabled]: ../assets/assets/screenshots/navigation-index-off.png
...
=== "Without"
  ...
  [Navigation integration enabled]: ../assets/assets/screenshots/toc-integrate.png
  [Navigation integration disabled]: ../assets/assets/screenshots/navigation-tabs.png
...
=== "Hide both"
  ...
  [Hide navigation enabled]: ../assets/assets/screenshots/hide-navigation.png
  [Hide table of contents enabled]: ../assets/assets/screenshots/hide-toc.png
  [Hide both enabled]: ../assets/assets/screenshots/hide-navigation-toc.png

### Hiding the Navigation Path

!!! desc "Hiding the Navigation Path"
...
:   This mode is active when the _search is focused_. It provides several key bindings to make search accessible and navigable via keyboard:
...
:   This mode is active when _search is not focussed_ and when there's no other focussed element that is susceptible to keyboard input. The following keys are bound:

    * ++f++ , ++s++ , ++slash++ : open search dialog
    * ++p++ , ++comma++ : go to previous page
    * ++n++ , ++period++ : go to next page

!!! tldr "Keyboard Shortcuts"
