...
![](imgs/20260604-180614.png){.centre-image}
...
!!! instruction "Design Principles"
    ...
    - **Maintain ownership**: Make accessibility a priority – users can navigate your documentation with touch devices, keyboard, and screen readers. Semantic markup ensures that your documentation works for everyone.
