...
<H1 style="text-align: center;"> <b>Setup</b></H1>

!!! info ""

    - Material for MkDocs offers a wide range of options for customizing your documentation. 
    
    - In this section, we will explain how you can create a meaningful structure for your site, change the look and feel, add a blog and comment system, and build a highly optimized site.
    
## Site Structure

!!! pied-piper "Site-Structure"
