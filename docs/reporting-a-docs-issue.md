![](imgs/reporting-a-docs-issue.png){ .center-image }
 
<H1 style="text-align: center;"><ins>Documentation issues</ins></H1>

# Documentation issues

!!! desc "Documentation issues"
...
!!! recommendation "Issue template"
  ...
  [reproduction]: creating-a-reproduction.md
  [Title]: #title
...
!!! desc "Description"
    ...
    -   __One issue at a time__ – if you encounter several unrelated inconsistencies, please create separate issues for them. Don't report them in the same issue – it makes attribution difficult.
