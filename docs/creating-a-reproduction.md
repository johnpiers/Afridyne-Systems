...
4.  As a last step, before packing everything into a `.zip` file, double-check
  ...
  [bug reporting guide]: MkDocs-Material/reporting-a-bug.md#upgrade-to-latest-version
  [minimal configuration]: MkDocs-Material/creating-your-site.md#minimal-configuration
