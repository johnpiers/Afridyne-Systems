...
??? example "Options"
    ...
    **\-gm**, **\-\-gpu_metrics**, **\-\-gpu-metrics**
    :   Dump gpu_metrics for all AMD GPUs. [Dump gpu_metrics](https://www.kernel.org/doc/html/latest/gpu/amdgpu/thermal.html#gpu-metrics)

    **\-\-pp_table**, **\-\-pp-table**
    :   Dump pp_table from sysfs and VBIOS for all AMD GPUs. (only support Navi1x and Navi2x, Navi3x)

    **\-\-drm_info**, **\-\-drm-info**
    :   Dump DRM info. Inspired by [drm_info](https://gitlab.freedesktop.org/emersion/drm_info)
