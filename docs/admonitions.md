...
![](imgs/20260102-211715.png){: style="display: block; margin: 0 auto"}
<H1 style="text-align: center;"><ins>Admonitions</ins></H1>

!!! pied-piper "Important"
     
    Admonitions, also known as _call-outs_, are an excellent choice for including side content without significantly interrupting the document flow. Material for MkDocs provides several different types of admonitions and allows for the inclusion and nesting of arbitrary content.</p>
    
## Configuration

This [color=#FF0000](https://www.color-hex.com/color/ff0000) configuration[/color] enables admonitions, allows to make them collapsible and to nest arbitrary content inside admonitions.
...
Each of the supported admonition types has a distinct icon, which can be changed to any icon bundled with the theme, or even a [custom icon].
...
??? example "Expand to show alternate icon sets"
  ...
  [icon search]: MkDocs-Material/icons-emojis.md
...
Prior to version <!-- md:version 8.5.6 -->, admonitions had a slightly different appearance:
